...
const argsParser = ParserCombinators_1.manyJoin(myChainParser, ParserCombinators_1.sequenceOf([ParserCreators_1.str(','), ParserCombinators_1.many(ParserCreators_1.spaces)], 1));
